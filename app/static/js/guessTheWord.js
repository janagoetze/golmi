$(document).ready(function () {
    ...
    var words = ['FACETIOUS', 'WORMHOLE', 'SOPORIFIC', 'LITERALLY',
                  'INCENTIVIZE', 'IRREGARDLESS', 'ENORMITY'];
    ...
    socket.on("update_config", (config) => {
        ...
        if (!setup_complete) {
            ...
            socket.emit("word_init", {"objs": word, "n_grip": N_GRIPPERS, "random_grip":false, "area_block": "all", "area_target": "all"});
